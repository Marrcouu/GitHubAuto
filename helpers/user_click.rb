class HelperUser
  ...
  @hash_user = {
      :click => {
          ...
          :personal => {boton1:{metodo:'find',tag: :id,etiqueta:'expand',wait:60},
                        boton2:{metodo:'find',tag: :css, etiqueta:'a[href="/settings/user"]', wait:50}},
          ...
          :configuration => {boton1:{metodo:'find',tag: :id,etiqueta:'expand',wait:60},
                             boton2:{metodo:'find',tag: :css,etiqueta:'a[href="/settings/user"]',wait:60}},
